...
public class SuperParkingBoyTest {
    ...
    @Test
    public void should_pick_car_failed_with_ticket_when_picking_given_parking_boy_has_two_lots_and_the_car_not_in_lots() {
        ParkingLot parkingLot1 = new ParkingLot(1);
        ParkingLot parkingLot2 = new ParkingLot(1);
        List<ParkingLot> parkingLots = new ArrayList<ParkingLot>();
        parkingLots.add(parkingLot1);
    ...
    @Test
    public void should_pick_car_success_at_first_time_failed_at_second_time_with_valid_ticket_when_picking_given_parking_boy_has_two_lots_and_the_car_in_lots() {
        ParkingLot parkingLot1 = new ParkingLot(1);
        ParkingLot parkingLot2 = new ParkingLot(1);
        List<ParkingLot> parkingLots = new ArrayList<ParkingLot>();
        parkingLots.add(parkingLot1);
        ...
        Ticket ticket = superParkingBoy.parking(car);
        assertSame(car, superParkingBoy.pick(ticket));
        assertNull(superParkingBoy.pick(ticket));
    }
}
